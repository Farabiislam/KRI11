  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-gradient-to-br from-cyan-500/20 to-[#3a3a3a] rounded-full blur-3xl animate-pulse delay-500"></div>

        {/* Floating particles */}
        <div className="absolute top-20 left-20 w-2 h-2 bg-blue-400 rounded-full animate-bounce delay-300"></div>
        <div className="absolute top-40 right-32 w-3 h-3 bg-[#3a3a3a] rounded-full animate-bounce delay-700"></div>
        <div className="absolute bottom-32 left-1/4 w-2 h-2 bg-cyan-400 rounded-full animate-bounce delay-1000"></div>
        <div className="absolute bottom-20 right-20 w-3 h-3 bg-indigo-600 rounded-full animate-bounce delay-500"></div>
      </div>
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        <RevealAnimation direction="fade" delay={200}>
          <div className="mb-8">
            <div className="relative w-36 h-36 lg:h-40 lg:w-40 mx-auto mb-6">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-blue-800 via-[#3a3a3a] to-cyan-600 rounded-full animate-spin-slow opacity-50"></div>
              <div className="absolute inset-2 bg-gradient-to-br from-cyan-600 via-[#3a3a3a] to-blue-800 rounded-full flex items-center justify-center shadow-2xl shadow-blue-500/50">
                <Image
                  width={40 * 4}
                  height={40 * 4}
        ...
        <RevealAnimation direction="up" delay={600}>
          <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">
            ...
            <span className="bg-gradient-to-r from-blue-400 via-[#ffffff] to-cyan-400 bg-clip-text text-transparent animate-gradient">
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-6">
              {[
                ...
                <span
                  key={keyword}
                  className="px-3 py-1 bg-gradient-to-r from-gray-800/80 to-gray-700/80 backdrop-blur-sm rounded-full text-sm text-[#bdbdbd] border border-gray-600 hover:border-blue-500/50 transition-all duration-300"
        ...
        <RevealAnimation direction="up" delay={1000}>
          <p className="text-lg text-[#bdbdbd] mb-12 max-w-3xl mx-auto leading-relaxed">
            ...
            {socialLinks.map((social, index) => {
              ...
              return (
                <a
                  ...
                  className="group relative p-4 bg-gray-800/50 backdrop-blur-sm rounded-xl hover:bg-[#3a3a3a] transition-all duration-300 border border-gray-700 hover:border-transparent hover:scale-110"
        ...
        <RevealAnimation direction="up" delay={1400}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <a
              href="https://drive.google.com/uc?export=download&id=1ptMQs_4QYtZ6KrZPjRa_U2y6x8WZosyR"
              target="_blank"
              rel="noopener"
